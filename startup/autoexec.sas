...
out_dir = location where the sas dataset will reside

OUTPUT:
&out_dir..Crash_Analysis_System_CAS_data = crash analysis system sas7bdat file
...
/* setup variables */
%let in_path = /home/&sysuserid.;     /* path to where the csv file is located */
%let out_dir = work;                  /* location where the sas dataset will reside */

data &out_dir..Crash_Analysis_System_CAS_data;
    length
        X                  8
        Y                  8
        OBJECTID           8
...
proc freq data = &out_dir..Crash_Analysis_System_CAS_data
	order = internal
;
